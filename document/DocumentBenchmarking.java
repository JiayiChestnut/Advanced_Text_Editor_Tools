	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int i = 0; i < trials; i ++) {
				BasicDocument bd = new BasicDocument(content);
				bd.getFleschScore();
			}
			double usedTime = (System.nanoTime() - startTime) / 1000000000.0 ;
			
			System.out.print(usedTime + "\t");
			//5. 
			long startTime2 = System.nanoTime();
			for (int i = 0; i < trials; i ++) {
				EfficientDocument ed = new EfficientDocument(content);
				ed.getFleschScore();
			}
			double usedTime2 = (System.nanoTime() - startTime2 ) / 1000000000.0;
