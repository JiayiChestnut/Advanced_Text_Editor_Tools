...
//				if (lastIsWord) {// if "get 7.5." is the sentence, then we will get ["get", "." "."], so this should be considered as 2 sentence.
//					numSentences ++;
//				}
				numSentences ++;
			}
