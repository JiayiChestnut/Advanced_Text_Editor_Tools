...
public class AutoCompleteDictionaryTrieTester {
	...
	private String dictFile = "data/words.small.backup.txt"; 
...
//		smallDict.printTree();
//		System.out.println(smallDict.isWord("hel"));
//		System.out.println(smallDict.searchNode(smallDict.root,"hel").getText());
